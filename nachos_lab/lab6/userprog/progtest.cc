...
void ff(int which){
    OpenFile *executable1 = fileSystem->Open("../test/test");
    AddrSpace *space1;
    space1 = new AddrSpace(executable1);
    space1->filename = "../test/test";
